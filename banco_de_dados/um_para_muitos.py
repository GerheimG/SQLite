...
# importar o módulo pathlib para trabalhar co caminhos relativos ou absolutos
...
# Caminho Relativo
db_path = Path('banco_de_dados') / 'bd_rel_1_n.db'
conn = sqlite3.connect(str(db_path))
cursor = conn.cursor()

# Criação da tabla 'Clientes' (Tabela Principal)
cursor.execute('''
...
def cliente_existe(id_cliente):
    ...
    # Retorna True se o cliente existir, Flase caso contrário
